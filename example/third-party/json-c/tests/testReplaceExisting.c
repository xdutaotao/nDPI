...
int main(int argc, char **argv)
{
	...
	json_object_object_add(my_object, "foo1",
			       json_object_new_string("bar1"));
	json_object_object_add(my_object, "foo2",
			       json_object_new_string("bar2"));
	json_object_object_add(my_object, "deleteme",
			       json_object_new_string("bar2"));
	json_object_object_add(my_object, "foo3",
			       json_object_new_string("bar3"));
	...
	json_object_object_foreach(my_object, key, val) {
		...
		original_key = key;
		json_object_object_add(my_object, key,
	...
	if (new_count != orig_count) {
		printf
		    ("mismatch between original count (%d) and new count (%d)\n",
